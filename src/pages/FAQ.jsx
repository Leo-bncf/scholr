...
const GROUPS = [
  ...
  },
  {
    ...
    items: [
      ...
      ['Does it send email?', 'Invitations and notifications send. What does not yet exist is PDF and Excel export, the Google Drive and Docs integrations, and report generation as a document you can hand to a parent — those are listed on the security page rather than buried.'],
