    ...
    <>
      <section className="legal-prose py-14 md:py-20">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <Link to={createPageUrl('Landing')} className="inline-flex items-center gap-2 text-slate-500 scholr-ink mb-8">
          ...
          <div className="mb-10 pb-8 border-b border-slate-200">
            <h1 className="text-4xl sm:text-5xl font-bold mb-4" style={{ color: 'var(--brand)' }}>Terms of Service</h1>
          ...
          <div className="space-y-10 text-slate-600 text-sm leading-relaxed">
            ...
            {/* Section 1 */}
            <section>
              <h2 className="text-xl font-bold mb-4" style={{ color: 'var(--brand)' }}>1. Company Information</h2>
            ...
            {/* Section 2 */}
            <section>
              <h2 className="text-xl font-bold mb-4" style={{ color: 'var(--brand)' }}>2. Purpose and Acceptance of Terms</h2>
            ...
            {/* Section 3 */}
            <section>
              <h2 className="text-xl font-bold mb-4" style={{ color: 'var(--brand)' }}>3. Description of the Service</h2>
            ...
            {/* Section 4 */}
            <section>
              <h2 className="text-xl font-bold mb-4" style={{ color: 'var(--brand)' }}>4. Account Creation and Access</h2>

              <h3 className="font-semibold mb-2" style={{ color: 'var(--brand)' }}>4.1 Institutional accounts</h3>
              ...
              <h3 className="font-semibold mb-2" style={{ color: 'var(--brand)' }}>4.2 Individual accounts</h3>
              ...
              <h3 className="font-semibold mb-2" style={{ color: 'var(--brand)' }}>4.3 Accounts for minors</h3>
              ...
              <h3 className="font-semibold mb-2" style={{ color: 'var(--brand)' }}>4.4 Account suspension and termination</h3>
            ...
            {/* Section 5 */}
            <section>
              <h2 className="text-xl font-bold mb-4" style={{ color: 'var(--brand)' }}>5. Acceptable Use Policy</h2>

              <h3 className="font-semibold mb-2" style={{ color: 'var(--brand)' }}>5.1 Permitted use</h3>
              ...
              <h3 className="font-semibold mb-2" style={{ color: 'var(--brand)' }}>5.2 Prohibited conduct</h3>
            ...
            {/* Section 6 */}
            <section>
              <h2 className="text-xl font-bold mb-4" style={{ color: 'var(--brand)' }}>6. Intellectual Property</h2>

              <h3 className="font-semibold mb-2" style={{ color: 'var(--brand)' }}>6.1 Scholr's intellectual property</h3>
              ...
              <h3 className="font-semibold mb-2" style={{ color: 'var(--brand)' }}>6.2 User-generated content</h3>
              ...
              <h3 className="font-semibold mb-2" style={{ color: 'var(--brand)' }}>6.3 Feedback</h3>
            ...
            {/* Section 7 */}
            <section>
              <h2 className="text-xl font-bold mb-4" style={{ color: 'var(--brand)' }}>7. Subscription and Payment</h2>

              <h3 className="font-semibold mb-2" style={{ color: 'var(--brand)' }}>7.1 Subscription plans</h3>
              ...
              <h3 className="font-semibold mb-2" style={{ color: 'var(--brand)' }}>7.2 Billing</h3>
              ...
              <h3 className="font-semibold mb-2" style={{ color: 'var(--brand)' }}>7.3 Late payment</h3>
              ...
              <h3 className="font-semibold mb-2" style={{ color: 'var(--brand)' }}>7.4 Refunds</h3>
              <p>Fees paid in advance are non-refundable except as expressly provided in the MSA or as required by applicable law.</p>
            </section>

            {/* Section 8 */}
            <section>
              <h2 className="text-xl font-bold mb-4" style={{ color: 'var(--brand)' }}>8. Data Protection and Privacy</h2>
            ...
            {/* Section 9 */}
            <section>
              <h2 className="text-xl font-bold mb-4" style={{ color: 'var(--brand)' }}>9. Service Availability and Maintenance</h2>

              <h3 className="font-semibold mb-2" style={{ color: 'var(--brand)' }}>9.1 Availability</h3>
              ...
              <h3 className="font-semibold mb-2" style={{ color: 'var(--brand)' }}>9.2 Planned maintenance</h3>
              ...
              <h3 className="font-semibold mb-2" style={{ color: 'var(--brand)' }}>9.3 Service levels</h3>
            ...
            {/* Section 10 */}
            <section>
              <h2 className="text-xl font-bold mb-4" style={{ color: 'var(--brand)' }}>10. Limitation of Liability</h2>
            ...
            {/* Section 11 */}
            <section>
              <h2 className="text-xl font-bold mb-4" style={{ color: 'var(--brand)' }}>11. Indemnification</h2>
            ...
            {/* Section 12 */}
            <section>
              <h2 className="text-xl font-bold mb-4" style={{ color: 'var(--brand)' }}>12. Third-Party Services and Integrations</h2>
            ...
            {/* Section 13 */}
            <section>
              <h2 className="text-xl font-bold mb-4" style={{ color: 'var(--brand)' }}>13. Term and Termination</h2>

              <h3 className="font-semibold mb-2" style={{ color: 'var(--brand)' }}>13.1 Term</h3>
              ...
              <h3 className="font-semibold mb-2" style={{ color: 'var(--brand)' }}>13.2 Termination by the school</h3>
              ...
              <h3 className="font-semibold mb-2" style={{ color: 'var(--brand)' }}>13.3 Termination by Scholr</h3>
              ...
              <h3 className="font-semibold mb-2" style={{ color: 'var(--brand)' }}>13.4 Effect of termination</h3>
            ...
            {/* Section 14 */}
            <section>
              <h2 className="text-xl font-bold mb-4" style={{ color: 'var(--brand)' }}>14. Governing Law and Dispute Resolution</h2>

              <h3 className="font-semibold mb-2" style={{ color: 'var(--brand)' }}>14.1 Governing law</h3>
              ...
              <h3 className="font-semibold mb-2" style={{ color: 'var(--brand)' }}>14.2 Amicable resolution</h3>
              ...
              <h3 className="font-semibold mb-2" style={{ color: 'var(--brand)' }}>14.3 Mediation</h3>
              ...
              <h3 className="font-semibold mb-2" style={{ color: 'var(--brand)' }}>14.4 Jurisdiction</h3>
            ...
            {/* Section 15 */}
            <section>
              <h2 className="text-xl font-bold mb-4" style={{ color: 'var(--brand)' }}>15. Changes to These Terms</h2>
            ...
            {/* Section 16 */}
            <section>
              <h2 className="text-xl font-bold mb-4" style={{ color: 'var(--brand)' }}>16. General Provisions</h2>
            ...
            {/* Section 17 */}
            <section>
              <h2 className="text-xl font-bold mb-4" style={{ color: 'var(--brand)' }}>17. Contact Information</h2>
