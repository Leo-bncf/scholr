      ...
      <div className="max-w-7xl mx-auto px-4 md:px-6 py-3 md:py-4">
        <div className="flex items-center justify-between gap-4 mb-2">
          <a href={createPageUrl(resolvedBackTo)}>
            <Button variant="ghost" size="sm" className="h-7 text-xs scholr-muted hover:scholr-ink -ml-2">
        ...
        <div className="flex items-start justify-between gap-4 flex-wrap">
          <div className="min-w-0">
            <div className="flex items-center gap-2 flex-wrap">
              <h1 className="text-xl md:text-2xl font-bold scholr-ink truncate">
                {classData.name}
              </h1>
              {classData.section && (
              ...
              {isArchived && (
                <Badge className="scholr-sunk scholr-muted text-[11px] gap-1">
                  <Archive className="w-3 h-3" /> Archived
                </Badge>
              )}
            </div>

            <div className="flex items-center gap-4 mt-1.5 text-xs scholr-muted flex-wrap">
