...
export default function TopMarqueeSection() {
  ...
  const marquees = [
    { text: "Scholr — Designed for International Schools", speed: 140, reverse: false, fontFamily: '"Georgia", "Times New Roman", serif', letterSpacing: "0.02em" },
    { text: "Built for IB, IGCSE, A-Levels, and US Curricula", speed: 170, reverse: false, fontFamily: '"Bodoni MT", "Bodoni 72", "Didot", serif', letterSpacing: "0.05em" },
    { text: "Scholr", speed: 40, reverse: true, fontFamily: '"Palatino", "Palatino Linotype", "Book Antiqua", serif', letterSpacing: "0.12em" },
    { text: "Role-Based Dashboards for Students, Teachers, Parents, and Admins", speed: 160, reverse: true, fontFamily: '"Snell Roundhand", "Segoe Script", "Brush Script MT", cursive', letterSpacing: "0.015em" },
    { text: "Assignments, Gradebooks, Reports, Messaging, and Timetables in One Place", speed: 200, reverse: false, fontFamily: '"Copperplate", "Copperplate Gothic Light", "Optima", sans-serif', letterSpacing: "0.08em" },
  ];
