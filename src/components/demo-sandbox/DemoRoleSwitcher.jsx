...
export default function DemoRoleSwitcher() {
  ...
  if (!open) {
    return (
      <button
        ...
        className="fixed bottom-6 right-6 z-50 rounded-full scholr-sunk text-white shadow-2xl h-12 w-12 flex items-center justify-center hover:scholr-sunk transition"
  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 rounded-2xl scholr-sunk text-white shadow-2xl p-2 flex items-center gap-1 border border-slate-700">
        ...
        return (
          <Link
            ...
            className={`flex items-center gap-1.5 px-3 py-2 rounded-lg text-xs font-semibold transition ${
              active ? 'bg-white text-slate-900' : 'scholr-faint hover:scholr-sunk hover:text-white'
            }`}
          >
      ...
      <button
        ...
        className="ml-1 p-2 rounded-lg text-slate-400 hover:scholr-sunk hover:text-white"
