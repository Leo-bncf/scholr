    ...
    <section className="mt-10 md:mt-14 rounded-md border border-slate-200 bg-white shadow-sm overflow-hidden">
      <div className="px-6 md:px-10 py-8 md:py-10">
        <div className="max-w-2xl">
          <p className="text-[10px] font-bold uppercase tracking-widest scholr-accent">
            End of demo
          </p>
          ...
          <div className="mt-6 flex flex-col sm:flex-row gap-3">
            <Link
              to="/Contact"
              className="inline-flex items-center justify-center gap-2 rounded-md scholr-sunk text-white px-5 py-2.5 text-sm font-semibold hover:scholr-sunk transition"
            >
              Book a demo
            ...
            <Link
              to="/Contact"
              className="inline-flex items-center justify-center gap-2 rounded-md border scholr-rule bg-white text-slate-900 px-5 py-2.5 text-sm font-semibold scholr-hover transition"
            >
        ...
        <ul className="flex flex-col sm:flex-row sm:items-center sm:gap-8 gap-3">
          {CREDIBILITY.map(({ icon: Icon, label }) => (
            <li key={label} className="flex items-center gap-2 text-xs md:text-sm text-slate-600">
              <Icon className="w-4 h-4 scholr-accent flex-shrink-0" />
