              ...
              <div className="relative h-full before:fixed before:inset-x-0 before:bottom-0 before:h-[70px] before:z-50 before:bg-gradient-to-t dark:before:from-blue-950 before:from-white">
                <div className="flex justify-between items-start p-8 h-auto">
                  ...
                  <motion.button
                    ...
                    className="h-10 w-10 shrink-0 flex items-center justify-center rounded-full bg-white dark:bg-blue-950 text-neutral-700 hover:bg-neutral-50 dark:hover:bg-neutral-950 dark:text-white/70 text-black/70 border border-gray-200/90 dark:border-blue-900 hover:border-gray-300/90 hover:text-black dark:hover:text-white dark:hover:border-blue-800 transition-colors duration-300 focus:outline-none z-50"
        ...
        <div className="flex gap-4 flex-col w-full h-full">
          ...
          <div className="flex justify-between items-center w-full flex-grow">
            ...
            <motion.button
              ...
              layoutId={`button-${title}-${cardId}`}
              className={cn(
                "h-8 w-8 shrink-0 flex items-center justify-center rounded-full bg-white dark:bg-blue-950 text-neutral-700 hover:bg-neutral-50 dark:hover:bg-neutral-950 dark:text-white/70 text-black/70 border border-gray-200/90 dark:border-blue-900 hover:border-gray-300/90 hover:text-black dark:hover:text-white dark:hover:border-blue-800 transition-colors duration-300  focus:outline-none",
                className,
              )}
            >
              <motion.div
