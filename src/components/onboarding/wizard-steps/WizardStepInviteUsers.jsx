...
export default function WizardStepInviteUsers({ schoolId, onDone }) {
  ...
  return (
    <div className="space-y-5">
      <div>
        <h3 className="text-base font-bold scholr-ink mb-1">Invite Your Team</h3>
        <p className="text-sm scholr-muted">Send invitations to teachers, coordinators, and students. They'll receive an email to create their account.</p>
      </div>
